...
import com. librarymgt.interceptor.DemoInterceptor;

@Configuration
@EnableWebMvc
@EnableTransactionManagement
@ComponentScan("com.librarymgt")
@EnableJpaRepositories("com.librarymgt.repository")
